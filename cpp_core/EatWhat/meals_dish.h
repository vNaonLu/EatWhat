...
namespace vnaon_meals {
	...
	public:
		MealPicking(const std::string &arg_name, const std::string &arg_address, MealFilter::Shared arg_filter);
		~MealPicking();
		...
		static MealPicking::Shared Create(const std::string &arg_name, const std::string &arg_address, MealFilter::Shared arg_filter = std::make_shared<MealFilter>());
